...
const CustomDropmenuCheckbox = ({ options = [], values = [], onChangeValues, label, limit = 2 }) => {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          className="focus-visible:ring-0 px-3 hover:text-slate-900 text-slate-900 font-normal border-slate-200 focus-visible:ring-offset-0"
          size="sm"
          variant="outline"
        >
          <BadgePlus size={16} />
...
export default CustomDropmenuCheckbox
CustomDropmenuCheckbox.propTypes = {
